...
Classes: none
Functions: inline func() - returns void - takes no args - creates two arrays filled with doubles and multiplies the entries
Variables:
...
This program performes the above calculation in an inline function and records the time it takes to perform the calculation. It then prints out
the elapsed time. On average, the elapsed time was 2 seconds.
*/
